...
from ai_safety_gym.helpers import factory
from .agent_viewer import AgentViewer
from ai_safety_gym.environments.shared import safety_game
from ai_safety_gym.environments.shared.termination_reason_enum import termination_reasons
class SafetyEnv(gym.Env):
  ...
  def __init__(self, env_name, use_transitions=False, render_animation_delay=0.1, seed=None, **kwargs):
    ...
    self._env: safety_game.SafetyEnvironment = factory.get_environment_obj(env_name, self, **kwargs)
  ...
  @classmethod
  def spec(self, env_name, **kwargs):
    return factory.get_environment_obj(env_name, self, **kwargs)
