...
from ai_safety_gridworlds.tests.GridWrapperSmallViewDistanceDirection import BasicWrapperDistanceDirection
...
env.reset()
wrappedEnv = BasicWrapperDistanceDirection(env)
seeds = [77]
seedsStr = []
LogPath = 'F:/ai-safety-gridworlds/log/DistanceDirection/'
LogDirs = []
for seed in seeds:
...
for j in range(10):
    ...
    TestEnv.reset()
    wrappedTestEnv = BasicWrapperDistanceDirection(TestEnv)
