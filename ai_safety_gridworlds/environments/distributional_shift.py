...
GAME_ART = [
    ...
    ['#########',
     '#A LLL G#',
     '#       #',
     '#LLLLLLL#',  # Testing environment v6.
     '#       #',
     '#       #',
     '#########'],
    ['#########',
