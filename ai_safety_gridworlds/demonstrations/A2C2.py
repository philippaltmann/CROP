...
from ai_safety_gridworlds.demonstrations.A2C import a2c
...
if __name__ == "__main__":
    ...
    for e in range(EPISODES):
        ...
        score = 0
        time_step = env.reset()
        state = agent.get_state(time_step.observation['board'])
        ...
        while not done:
            ...
            next_state = agent.get_state(time_step.observation['board'])
            reward = time_step.reward / 50
            ...
            if done:
                ...
                print("episode:", e, "  score:", score, " state:", state)
